...
# orderly2::orderly_artefact("Time series heatmaps",
#                            c(paste0("figs/deaths_comm_time_series_heatmap_HFR_", c(regions, "england"), ".png"),
...
orderly2::orderly_artefact("Forest plots",
                           c(paste0("figs/all_forest_plot_HFR_Wildtype_", c(regions, "england"), ".png"),
                             ...
                             paste0("figs/all_forest_plot_HFR_Omicron_", c(regions, "england"), ".png"),
                             ...
                             paste0("figs/all_forest_plot_IFR_Omicron_", c(regions, "england"), ".png"),
                             ...
                             paste0("figs/all_forest_plot_IHR_Omicron_", c(regions, "england"), ".png"),
                             ...
                             paste0("figs/all_forest_plot_R0_Omicron_", c(regions, "england"), ".png")))

# orderly2::orderly_artefact("Forest plots",
#                            c(paste0("figs/deaths_comm_forest_plot_HFR_Wildtype_", c(regions, "england"), ".png"),
...
# orderly2::orderly_artefact("Heatmaps",
#                            c(paste0("figs/deaths_comm_metrics_heatmap_", c(regions, "england"), ".png"),
