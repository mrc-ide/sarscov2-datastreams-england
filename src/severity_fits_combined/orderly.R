...
for (r in sircovid::regions("england")) {
  orderly2::orderly_dependency(
    "severity_fits",
    quote(latest(parameter:region == environment:r && parameter:data_changed == this:data_changed && parameter:short_run == this:short_run && parameter:deterministic == this:deterministic && parameter:percent_removed == this:percent_removed)),
